  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <motion.header 
        ...
        className="fixed top-0 left-0 right-0 z-50 border-b border-gray-800 bg-gray-950/80 backdrop-blur-xl"
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-emerald-500/25 transition-all duration-300">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login" className="text-sm font-medium text-gray-400 hover:text-emerald-400 transition-colors">
              Sign In
            </Link>
            <Link href="/register">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Link href="/register">
                <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-lg px-8 shadow-xl hover:shadow-emerald-500/25 transition-all duration-300 hover:-translate-y-1">
                  Start Free Trial
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              </Link>
              <Link href="/status/demo">
                <Button size="lg" variant="outline" className="text-lg px-8 border-gray-700 text-gray-300 hover:bg-gray-800 hover:border-emerald-500/50 hover:text-emerald-400 transition-all duration-300">
                  View Demo
                </Button>
              </Link>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-green-500 rounded-2xl blur-2xl opacity-10" />
            <div className="relative bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-800">
              <div className="bg-gray-800 px-4 py-3 flex items-center gap-2">
                ...
                <span className="ml-4 text-sm text-gray-500">status.yourcompany.com</span>
              </div>
              <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-2xl font-bold text-gray-100">All Systems Operational</h3>
      ...
      <section className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-4 text-gray-100">Everything You Need</h2>
            <p className="text-xl text-gray-400">Powerful features to keep your services running smoothly</p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div key={feature.title} variants={fadeInUp}>
                <Card className="group h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-gray-800/50 backdrop-blur border border-gray-700/50">
                  <CardHeader>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="relative bg-gray-900 rounded-3xl p-12 shadow-2xl border border-gray-800">
              <h2 className="text-4xl font-bold mb-4 text-gray-100">Ready to Get Started?</h2>
              ...
              <p className="mt-6 text-sm text-gray-500">Free 14-day trial. No credit card required.</p>
            </div>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold text-gray-100">StatusPage</span>
              </div>
